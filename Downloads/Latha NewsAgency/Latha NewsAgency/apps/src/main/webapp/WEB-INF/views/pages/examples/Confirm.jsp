...
<html>
    ...
    margin-bottom: 30px;">
				<div>
				 <h3 align="center">User has been successfully registered. </br></br>Registration Number is ${RegNum}</h3>
				 </br>
				  <h3 align="center">Please check your email to complete registration</h3>
