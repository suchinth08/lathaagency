...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Latha NewsAgency|Confirm</title>
    ...
    margin-bottom: 30px;">
				<div>
				 <h3 align="center">Thanks for updating Pay Details.</br></br>Your InVoice Number is ${inVoice}</h3>
				 </br>
				  <h3 align="center">We will update on email, once payment is approved.</h3>
				  </br>
				   <h3 align="center">Thanks for your help and support</h3>
