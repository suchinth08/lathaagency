...
">
						...
						<p><strong><i>&nbsp&nbsp&nbsp&nbsp&nbsp&nbspPlease use below details to make payment and provide Transaction ID to complete Transaction<br></br>
					        	&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp1. Internet Banking (Bank : Axis Bank, Name: Latha L Latha, Acc No: 347834223, IFSC Code: AX34845)</br>
					        	&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp2. PhonePe: 9902026925 
					        	&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp3. PayTm: 9902026925
					        	&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp4. Bhim(UPI): 9902026925 </i></strong></p>
						</div>
							<div class="form-group" >
								<!-- <div class="text-left"> -->
								<!-- First Name-->
							...
							<div class="form-group">
								<label class="label1">Apartment Name:</label>  ${apartment }
									<label
									class="label1">Street/Rd No:</label> ${street }
							</div>

						<div class="form-group">
							<label class="label1">Locality:</label> ${locality}
								
							 <label class="label1">City:</label>${city}
						</div>

						<div class="form-group">
								<label class="label1">Pin:</label>${pin} 
								<label class="label1">Registration ID:</label><input name="regNum"  value=${regNum} readonly></input>
					...
					ID</label> <input type="text" class="search" id = "regNum" name="regNum"  placeholder=${regNum} style="background-color: white;font-weight: bold;width: 76px;height: 33px;" /> -->
						...
						<div class="form-group">	
	    				<label class="labelDropdown" for="accessTypelabel">Choose Month(s) of Payment</label> 	
				    	...
				    	<label class="labelDropdown" for="orderTypelabel">Payment Type</label>
   					 		...
   					 		<label class="label1">Transaction Number</label>
								<input type="text" class="search" id="transNumber" name="transactionNo" placeholder="Transaction Number" required />
				    	</div>	
