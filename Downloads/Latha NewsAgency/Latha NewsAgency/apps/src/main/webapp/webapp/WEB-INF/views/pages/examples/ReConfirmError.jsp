...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Latha NewsAgency|ReConfirmError</title>
...
">
				<div>
				 <h3 align="center">User has been not successfully registered.</h3>
				 </br>
				  <h3 align="center">Please re-register using below link</h3></br>
				    <h3 align="center"> <a href="${pageContext.request.contextPath}/pages/examples/register">Login</h3>
