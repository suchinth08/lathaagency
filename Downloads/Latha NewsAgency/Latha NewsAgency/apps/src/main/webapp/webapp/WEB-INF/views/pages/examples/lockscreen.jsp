...
<html class="lockscreen">
    <head>
        <meta charset="UTF-8">
        <title>Latha NewsAgency|LockScreen</title>
    ...
    <body>
        ...
        <div class="center">            
            ...
            <!-- User name -->
            <div class="lockscreen-name"><%=session.getAttribute("loggedInUser")%></div>
            
            <!-- START LOCK SCREEN ITEM -->
            <div class="lockscreen-item">
                <!-- lockscreen image -->
                <div class="lockscreen-image">
                    <img src="${pageContext.request.contextPath}/resources/img/avatar3.png" alt="user image"/>
                </div>
                <!-- /.lockscreen-image -->
