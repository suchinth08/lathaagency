...
function addPopup(data) {
	...
	$("#floorNo").attr("value", data.floorNo);
	$("#apartment").attr("value", data.apartment);
	$("#street").attr("value", data.street);
	$("#locality").attr("value", data.locality);
	$("#city").attr("value", data.city);
	$("#pin").attr("value", data.pin);
	$("#id").attr("value", data.regNum);
	
	//alert(data.regNum);
	
	$("#order").attr("value", data.regNum);
	 $("#ATOS").attr("value", data.ATOSTicket);
	 console.log("ATOSTicket no is :"+data.regNum);
