...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Latha NewsAgency|Login Error</title>
    ...
    <body >
     <body class="skin-blue">
		...
		<div id="contentHeader">
		 <p class="text-danger">Login Failed !!! Please re-try</p>
		</div>
		<br /> Please try again! <br />
		<form  id="login" modelAttribute="loginForm" action="${pageContext.request.contextPath}/pages/login"  method="post">
