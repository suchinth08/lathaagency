...
<title>Insert title here</title>
		...
		<!-- POP up style -->
        <link href="${pageContext.request.contextPath}/resources/css/add.user.popup.css" rel="stylesheet" type="text/css" />
        <!-- POP up script -->
        <script src="${pageContext.request.contextPath}/resources/js/popup-page.js" type="text/javascript"></script>
