...
<html>
	...
	<section class="content-header no-margin">
		<h1 class="text-center">MRRB QC Queue</h1>
	</section>
							...
							<div class="col-md-3 col-sm-4">
								...
								<div style="margin-top: 6px;">
									<ul class="nav nav-pills nav-stacked">
										...
										<li><a href="#"><i class="fa fa-folder"></i> Deferred</a></li>
									</ul>
								</div>
							</div>
							<!-- /.col (LEFT) -->
									...
									<div class="col-sm-6">
										...
										<div class="btn-group">
											...
											<ul class="dropdown-menu" role="menu">
												<li><a href="#">Move to Completed</a></li>
												<li><a href="#">Move to Pending</a></li>
												<li class="divider"></li>
												<li><a href="#">Move to Starred</a></li>
												<li class="divider"></li>
												<li><a href="#">Move to Deferred</a></li>
											</ul>
										</div>
									...
									<table class="table table-mailbox">
										<tr class="unread">
										 <tr>
											...
											<td class="name"><a href="#">Geetha Ramamoorthy</a></td>
											<td class="QCNumber"><a href="#">QC1233</a></td>
											<td class="time">12:30 PM</td>
											<td class="TeamAssigned">MicroServices</td>
											<td class="Developer">Sudheer Chnithala</td>
											<td class="Tester">Vijay</td>
										</tr>
										 </tr>
											<td class="small-col"><input type="checkbox" /></td>
											<td class="small-col"><i class="fa fa-star"></i></td>
											<td class="name"><a href="#">Murali</a></td>
											<td class="QCNumber"><a href="#">QC1234</a></td>
											<td class="time">12:30 PM</td>
											<td class="TeamAssigned">Instar</td>
											<td class="Developer">Suneel</td>
											<td class="Tester">SaiLeela</td>
										</tr>
										 </tr>
											<td class="small-col"><input type="checkbox" /></td>
											<td class="small-col"><i class="fa fa-star"></i></td>
											<td class="name"><a href="#">Micheal</a></td>
											<td class="QCNumber"><a href="#">QC1236</a></td>
											<td class="time">1:00 PM</td>
											<td class="TeamAssigned">ICORE</td>
											<td class="Developer">Sanjeev</td>
											<td class="Tester">Deepansha</td>
										</tr>
										 </tr>
											<td class="small-col"><input type="checkbox" /></td>
											<td class="small-col"><i class="fa fa-star"></i></td>
											<td class="name"><a href="#">Arsen</a></td>
											<td class="QCNumber"><a href="#">QC1283</a></td>
											<td class="time">4:30 PM</td>
											<td class="TeamAssigned">Logical Prov</td>
											<td class="Developer">Ivetta</td>
											<td class="Tester">Ashwitha</td>
										</tr>
										</tr>
											<td class="small-col"><input type="checkbox" /></td>
											<td class="small-col"><i class="fa fa-star"></i></td>
